...
export function OcrRemitosPage() {
  ...
  const handleTestExtract = useCallback(async () => {
    ...
    setTestFields(null);
    try {
      const preparedBlob = await prepareImageBlobForUpload(capturedBlob, rotationDegrees);
  ...
  const uploadDocument = useCallback(async () => {
    ...
    try {
      const uploadBlob = await prepareImageBlobForUpload(capturedBlob, rotationDegrees);
